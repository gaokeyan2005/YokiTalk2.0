...
namespace NIM.SysMessage
{
    namespace Delegate
    {
        ...
        internal delegate void ReceiveSysMsgDelegate([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof (Utf8StringMarshaler))] string result, IntPtr user_data);

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate void CustomSysMsgArcDelegate([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof (Utf8StringMarshaler))] string result, IntPtr user_data);

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate void QuerySysMsgDelegate(int count, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof (Utf8StringMarshaler))] string result, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof (Utf8StringMarshaler))] string json_extension, IntPtr user_data);

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void OperateSysMsgDelegate(int res_code, int unread_count, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof (Utf8StringMarshaler))] string json_extension, IntPtr user_data);

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void OperateSysMsgExternDelegate(int res_code, long msg_id, int unread_count, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof (Utf8StringMarshaler))] string json_extension, IntPtr user_data);
    }


    internal class SysMsgNativeMethods
    {
        ...
        public static extern void nim_sysmsg_reg_sysmsg_cb([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof (Utf8StringMarshaler))] string json_extension, ReceiveSysMsgDelegate cb, IntPtr user_data);
        ...
        public static extern void nim_sysmsg_send_custom_notification([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof (Utf8StringMarshaler))] string json_msg, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof (Utf8StringMarshaler))] string json_extension);
        ...
        public static extern void nim_sysmsg_reg_custom_notification_ack_cb([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof (Utf8StringMarshaler))] string json_extension, CustomSysMsgArcDelegate cb, IntPtr user_data);
        ...
        public static extern void nim_sysmsg_query_msg_async(int limit_count, long last_time, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof (Utf8StringMarshaler))] string json_extension, QuerySysMsgDelegate cb, IntPtr user_data);
        ...
        public static extern void nim_sysmsg_query_unread_count([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof (Utf8StringMarshaler))] string json_extension, OperateSysMsgDelegate cb, IntPtr user_data);
        ...
        public static extern void nim_sysmsg_set_status_async(long msg_id, NIMSysMsgStatus status, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof (Utf8StringMarshaler))] string json_extension, OperateSysMsgExternDelegate cb, IntPtr user_data);
        ...
        public static extern void nim_sysmsg_read_all_async([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof (Utf8StringMarshaler))] string json_extension, OperateSysMsgDelegate cb, IntPtr user_data);
        ...
        public static extern void nim_sysmsg_delete_async(long msg_id, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof (Utf8StringMarshaler))] string json_extension, OperateSysMsgExternDelegate cb, IntPtr user_data);
        ...
        public static extern void nim_sysmsg_delete_all_async([MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof (Utf8StringMarshaler))] string json_extension, OperateSysMsgDelegate cb, IntPtr user_data);
        ...
        public static extern void nim_sysmsg_set_logs_status_by_type_async(NIMSysMsgType type, NIMSysMsgStatus status, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof (Utf8StringMarshaler))] string json_extension, OperateSysMsgDelegate cb, IntPtr user_data);
        ...
        public static extern void nim_sysmsg_delete_logs_by_type_async(NIMSysMsgType type, [MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof (Utf8StringMarshaler))] string json_extension, OperateSysMsgDelegate cb, IntPtr user_data);
    }
}