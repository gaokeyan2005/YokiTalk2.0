...
namespace NIM
{
    ...
    class TalkNativeMethods
    {
        ...
        [DllImport(NIMGlobal.NIMNativeDLL, EntryPoint = "nim_talk_recall_msg", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(NIMGlobal.NIMNativeDLL, EntryPoint = "nim_talk_reg_recall_msg_cb", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.Cdecl)]
