            ...
            using (SolidBrush brush = new SolidBrush(baseColor))
            {
                if (style != RoundStyle.None)
                {
                    using (GraphicsPath path =
                        RectangleEx.CreatePath(rect, roundWidth, style))
                    {
                    ...
                    if (baseColor.A > 80)
                    {
                        System.Drawing.Rectangle rectTop = rect;
                        ...
                        using (GraphicsPath pathTop = RectangleEx.CreatePath(
                            rectTop, roundWidth, RoundStyle.LeftTop | RoundStyle.RightTop))
                        {
